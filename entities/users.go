...
func FindUser(ctx context.Context, exec boil.ContextExecutor, lineUserID null.String, selectCols ...string) (*User, error) {
	userObj := &User{}
	...
	query := fmt.Sprintf(
		"select %s from \"users\" where \"line_user_id\"=?", sel,
	)

	q := queries.Raw(query, lineUserID)
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to upsert users")
	}
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"users\" WHERE \"line_user_id\"=?"
...
func (o *User) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindUser(ctx, exec, o.LineUserID)
	if err != nil {
		return err
	}
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, lineUserID null.String) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"users\" where \"line_user_id\"=? limit 1)"

	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, sql)
		fmt.Fprintln(writer, lineUserID)
	}
	row := exec.QueryRowContext(ctx, sql, lineUserID)
...
func (o *User) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return UserExists(ctx, exec, o.LineUserID)
}
